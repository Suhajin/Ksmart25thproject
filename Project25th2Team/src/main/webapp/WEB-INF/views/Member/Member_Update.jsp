            ...
            <div class="panel-body">
                <form id="memberupdate-form" action=/updateMemberAction method="post">
                    ...
                    <div>
                     ...
                     <div>
                   		<strong>전화번호</strong> 
                        <input type="text" class="form-control" name="memberPhone" value="${Member.memberPhone}" autofocus>
                    </div>
                     <div>
                   		<strong>이메일</strong> 
                        <input type="text" class="form-control" class="form-control" name="memberEmail" value="${Member.memberEmail}">
                    </div>
                     <div>
                   		<strong>우편주소</strong> 
                        <input type="text" id="sample3_postcode" class="form-control" name="memberPostNum" value="${Member.memberPostNum}">
                     ...
                     <div>
                   		<strong>주소</strong> 
                        <input type="text" id="sample3_address" class="form-control" name="memberAddress" value="${Member.memberAddress}">
                    </div>
                     <div>
                   		<strong>상세주소</strong> 
                        <input type="text" id="sample3_address" class="form-control" name="memberDetailAddress" value="${Member.memberDetailAddress}">
                    </div>
