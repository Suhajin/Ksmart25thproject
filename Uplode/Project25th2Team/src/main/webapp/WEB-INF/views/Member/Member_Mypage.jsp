	...
	<div class="content" id="content">
		...
		<div class="base_info">
			...
			<div class="info_area">
				...
				<span><strong>전화번호</strong> : ${Member.memberPhone}</span> <span><strong>이메일</strong>
					: ${Member.memberEmail}</span> <span class="address"> <strong>우편번호</strong>
					: ${Member.memberPostNum}
				</span> <span class="address"> <strong>주소</strong> :
					${Member.memberAddress}
				</span> <span class="address"> <strong>상세주소</strong> :
