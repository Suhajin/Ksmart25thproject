...
public class Action {
	...
	private String actionCheckDate;
	...
	public String getActionCheckDate() {
		return actionCheckDate;
	}
	public void setActionCheckDate(String actionCheckDate) {
		this.actionCheckDate = actionCheckDate;
	}
	@Override
	public String toString() {
		return "Action [actionCode=" + actionCode + ", detailGoalCode=" + detailGoalCode + ", memberCode=" + memberCode
				...
				+ ", actionCheckDate=" + actionCheckDate + "]";
	}
